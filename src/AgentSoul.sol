...
contract AgentSoul {
     ...
     */
    function mintSoul(address agent, string memory name, string memory model, string memory description)
        external
        returns (uint256)
    {
     ...
     */
    function recordAction(uint256 tokenId, string memory actionType, string memory actionHash) external {
     ...
     */
    function getSoul(address agent)
        external
        view
        returns (
            string memory name,
        ...
        )
    {
        ...
        return (soul.name, soul.model, soul.creator, soul.birthBlock, soul.description, actionCount[tokenId]);
    }
